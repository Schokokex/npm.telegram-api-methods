...
export default abstract class TelegramApi {
   ...
   */
  async getMe(): Promise<FetchResult<User>> {
   ...
   */
  async getMyCommands(): Promise<FetchResult<BotCommand[]>> {
    return this.fetch("getMyCommands", {});
  }
  ...
  async getWebookInfo(): Promise<FetchResult<WebhookInfo>> {
   ...
   */
  async getUserProfilePhotos(obj: {
    user_id: number;
    offset?: number;
    limit?: number;
   ...
   */
  async getFile(obj: { file_id: string }): Promise<FetchResult<File>> {
   ...
   * @param chat_id Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername)
   */
  async getChat(obj: { chat_id: number | string }): Promise<FetchResult<Chat>> {
   ...
   * @param chat_id Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername)
   */
  async getChatAdministrators(obj: {
    chat_id: number | string;
   ...
   */
  async getStickerSet(obj: { name: string }): Promise<FetchResult<StickerSet>> {
